...
function _showErrorOrAuthenticate(error) {
    ...
    if (error.status === 401) {
        ...
        const loginUrl = `${settings.loginUrl}?return_url=${encodeURIComponent(currentUrl)}`;

        // Add debugging
        console.log('=== Client-side Authentication Debug ===');
        console.log('Current URL:', currentUrl);
        console.log('Settings loginUrl:', settings.loginUrl);
