import "./dom/node/Document.js";
import "./dom/node/Node.js";
import "./dom/node/Element.js";
import { XPathResult } from "./dom/node/XPathResult.js";
import { DOMParser } from "./dom/node/DOMParser.js";
import { XSLTProcessor } from "./dom/node/XSLTProcessor.js";
import { NodeTypes } from "./dom/shared.js";
import xslForm from "./xsl/openrosa2html5form.xsl.js";
import xslModel from "./xsl/openrosa2xmlmodel.xsl.js";
import { parseLanguage } from "./language.js";
import { markdownToHTML } from "./markdown.js";
import { NAMESPACES } from "./shared.js";
import { escapeURLPath, getMediaPath } from "./url.js";
...
const transform = async (survey) => {
  ...
  const form = markdown !== false ? renderMarkdown(htmlDoc, mediaMap) : docToString(htmlDoc);
...
const isDocument = (node) => node.nodeType === NodeTypes.DOCUMENT_NODE;
...
const getLanguageSampleText = (doc, language) => {
  var _a;
