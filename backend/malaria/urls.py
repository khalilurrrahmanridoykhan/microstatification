...
from .views import (
    ...
    MicrostatificationPublicDashboardDataView,
...
urlpatterns = [
    ...
    path("microstatification/public/dashboard-data/", MicrostatificationPublicDashboardDataView.as_view(), name="malaria-microstatification-public-dashboard-data"),
