...
function AdminAssignForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 2️⃣ Update only form
            const updatedProfile = {
                ...currentProfile,
                forms: Array.from(new Set([...currentProfile.forms, selectedForm])),
                active_user: activeUser,
                receive_updates: receiveUpdates,
            };

            // 3️⃣ Promote to form-level role (4) – no demotion
            const candidateRole = 4;
            ...
            toast.success("User assigned to form successfully!");

            // 5️⃣ Reset form selector
            setSelectedForm("");
        } catch (err) {
            console.error(err);
            toast.error("Error assigning form");
        }
    };
            ...
            >
                ...
                <div className="col-span-1 form-group">
                    ...
                    >
                        ...
                        {orgs.filter((org) => allowedOrgIds.includes(org.id)).map((org) => (
                ...
                <div className="col-span-2 mt-6 button-container">
                    <button
                        ...
                        disabled={
                            !selectedOrg || !selectedUser || !selectedProject || !selectedForm
                        }
                    >
                        Save
                    </button>
...
export default AdminAssignForm;
