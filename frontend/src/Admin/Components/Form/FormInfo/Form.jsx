...
const Form = ({ formMeta = null }) => {
  ...
  const [allowAnonymousSubmissions, setAllowAnonymousSubmissions] =
    useState(Boolean(formMeta?.allow_anonymous_submissions));
    ...
    <div className="px-8 py-6">
      ...
      <div className="p-4 mb-5 bg-white border border-gray-200 rounded-md">
        ...
        <div className="flex justify-between text-gray-500 text-md">
          <span>
            <span className="font-semibold">Languages</span>: This project has
