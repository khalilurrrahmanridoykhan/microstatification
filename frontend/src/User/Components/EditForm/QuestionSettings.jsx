...
const QuestionSettings = ({ question, onChange, allQuestions }) => {
    ...
    <div className="question-settings">
      ...
      <Collapse in={openSkipLogic}>
        <div id="skip-logic-collapse">
          ...
          <div className="mb-3">
            <label className="form-label">Skip Logic:</label>
            <Form.Select
              value={question.skipLogic?.question || ''}
              onChange={e => onChange('skipLogic', { ...question.skipLogic, question: e.target.value })}
            >
