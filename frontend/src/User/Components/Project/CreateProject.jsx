...
function CreateProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userRes = await axios.get(`${BACKEND_URL}/api/users/${userInfo.username}/`, {
        headers: { Authorization: `Token ${token}` },
      });

      const existingProjects = userRes.data.profile.projects || [];

      await axios.patch(`${BACKEND_URL}/api/users/${userInfo.username}/`, {
        profile: {
