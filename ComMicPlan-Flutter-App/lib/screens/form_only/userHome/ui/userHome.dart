...
import 'package:gmgi_project/screens/form_only/all_organization/ui/all_organization.dart';
...
import 'package:gmgi_project/screens/form_only/fillUp/ui/fillUp.dart';
import 'package:gmgi_project/screens/form_only/all_project/ui/all_project.dart';
import 'package:gmgi_project/screens/form_only/saved_answer/ui/saved_answer.dart';
...
import 'package:gmgi_project/bloc/form_only/userHome/bloc/user_home_bloc.dart';
          ...
          children: [
            ...
            BlocConsumer<UserHomeBloc, UserHomeState>(
              ...
              listener: (context, state) {
                ...
                } else if (state is UserHomeNavigateToAllProjectState) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AllProject()),
                  );
                } else if (state is UserHomeNavigateToAllOrganizationState) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AllOrganization()),
                  );
                }
              },
              builder: (context, state) {
                switch (state.runtimeType) {
                  case UserHomeLoadedProjectAdminState:
                    return Column(
                      children: [
                        Expanded(
                          child: Scrollbar(
                                    ...
                                    GridView.count(
                                      ...
                                      children: <Widget>[
                                        ...
                                        GestureDetector(
                                          onTap: () async {
                                            _userHomeBloc.add(
                                              UserHomeAllProjectButtonPressed(),
                                            );
                                          },
                                          child: ClipRRect(
                                            borderRadius: BorderRadius.circular(
                  ...
                  case UserHomeLoadedOrganizationAdminState:
                  case UserHomeLoadedSuperAdminState:
                    return Column(
                      children: [
                        Expanded(
                          child: Scrollbar(
                                    ...
                                    GridView.count(
                                      ...
                                      children: <Widget>[
                                        ...
                                        GestureDetector(
                                          onTap: () async {
                                            _userHomeBloc.add(
                                              UserHomeAllOrganizationButtonPressed(),
                                            );
                                          },
                                          child: ClipRRect(
                                            borderRadius: BorderRadius.circular(
